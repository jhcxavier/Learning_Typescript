...
//in TypeScript all categories must be defined at the class level
//We always need to provide information for typescript, the more information, more it can help us

//initializing with =[] as a 
// PRIVATE is only visible for members od the same class
private _categories:Category[]=[];
//_items returns an array, we can use the interface we created in model.ts
private _items:InventoryItem[]=[];
//Below is a Promise that returns a boolean value!
private _isInitialized:Promise<boolean>;
   ...
   */
  //we can apply access modifiers to methods
  protected _load() {
    return Promise.all([
